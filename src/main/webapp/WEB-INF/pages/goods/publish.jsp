                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <%--<img src="<%=request.getContextPath()%>/resources/upload/default.jpeg" id="previewImg" style="width: 200px; height: 200px" alt="预览图片">--%>
                            <img src="<%=request.getContextPath()%>/img/default.jpeg" id="previewImg" style="width: 200px; height: 200px; float: right" alt="预览图片">
                    </div>
                </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="input-group col-xs-4">
                                ...
                                <f:input path="amount" id="inputAmount" cssClass="form-control text-center" value="1" onkeyup="value=value.replace(/[^\d]/g,'1')" placeholder="请输入数字"/>
